...
class CheckboxPage(BasePage):
    ...
    def expand_checkbox(self):
        ...
        for element in range(0, len(level2_checkboxes)):
            ...
            self.wait.until(EC.element_to_be_clickable(level2_checkboxes[element])).click()
            ...
            if count == len(level2_checkboxes) and len(level3_checkboxes) > 0:
                ...
                for child_element in level3_checkboxes:
                    # self.wait.until(EC.element_to_be_clickable(child_element)).click()
                    self.click_element(child_element)
    ...
    def expand_level2_checkbox(self, level2_checkbox_label=None):
        ...
        self.click_element(By.XPATH, level2_check_box_xpath)
    ...
    def expand_private_checkbox(self):
        ...
        self.click_element(By.XPATH, private_checkbox_xpath)
        flag = True
